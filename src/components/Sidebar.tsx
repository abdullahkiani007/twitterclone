...
const Sidebar = () => {
  ...
  return (
    <div
      className={`mx-1 md:mx-4 flex mt-2 h-full min-[1250px]:ml-60 text-white  bg-black ${
        (pathname === "/login" || pathname === "/signup" || !session) &&
        "hidden"
      }`}
    >
      <div className="flex flex-col w-16 md:w-64">
        ...
        <Link href="/home">
          <div className="flex items-center mb-2 md:mb-4 hover:bg-blue-500 hover:text-white p-2 rounded-lg cursor-pointer">
            ...
            <span className="hidden md:block ml-2 font-semibold text-lg">
              Home
            </span>
          </div>
        </Link>
        ...
        <div className="mt-auto">
          ...
          <div
            className="flex items-center p-4  hover:text-white cursor-pointer"
